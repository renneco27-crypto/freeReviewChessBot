...
document.getElementById('sampleMarshallBtn')?.addEventListener('click', function() {
  document.getElementById('pgnInput').value = MARSHALL_PGN;
  document.getElementById('reviewBtn').click();
});
